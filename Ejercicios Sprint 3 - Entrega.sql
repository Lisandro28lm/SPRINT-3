...
INSERT INTO credit_card (id, iban, pan, pin, cvv, expiring_date)  VALUES ("CcU-9999", "R323456312213576817699888", "5424465566813630", "5732", "985", "2022-10-30");

INSERT INTO transaction (id, credit_card_id, company_id, user_id, lat, longitude, timestamp, amount, declined) values ("108B1D1D-5B23-A76C-55EF-C568E49A99DD",	"CcU-9999",	"b-9999",	"9999",	"829999",	"-117999", null	,	"111.11",	"0");
...
SELECT c.company_name as Nombre, c.phone as Telefono, c.country as Pais, avg(t.amount) as Promedio
FROM company as c
...
select t.id as NrOp, d.name as Nombre,d.surname as Apellido, cr.iban as IBAN, co.company_name as Compañia
